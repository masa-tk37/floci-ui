...
export function ObjectList({
  ...
  const bucketRailItems = buckets.map((entry) => {
      ...
      >
        ...
        <div class="resource-workspace s3-object-list-page__workspace">
          {buckets.length > 0 ? (
            <ResourceRail
              title="Buckets"
              searchPlaceholder="Bucket を検索"
              items={bucketRailItems}
              emptyLabel="一致する Bucket がありません"
            />
          ) : null}
          <div class="resource-main s3-object-list-page__main">
                ...
                <div x-show="!propertyLoading" x-cloak>
                  <div class="s3-object-list-page__meta-grid">
                    <div class="s3-object-list-page__meta-card">
                      <span class="s3-object-list-page__meta-label">
                        サイズ
                      </span>
                      <span
